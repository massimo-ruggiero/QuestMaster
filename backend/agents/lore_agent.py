...
class LoreAgent:
    ...
    def _build_workflow(self):
        ...
        workflow_img_path = "backend/images/"
        workflow_img_name = "workflow_lore_agent"
    ...
    def _run_workflow(self):
        try:
            ...
            self.output_queue.put({
                "message": "Hey there! I’m your virtual assistant—what ideas are you cooking up for the lore?",
                "action": "continue"
            })
    ...
    def start_chat(self):
        if self.is_running:
            return {"message": "Hey there! I’m your virtual assistant—what ideas are you cooking up for the lore?", "action": "continue"}
