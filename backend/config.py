import yaml
from utils import fill_lore_system_template, fill_generative_system_template, fill_retrieval_system_template
...
# PDDL
PDDL_SYSTEM_TPL = fill_generative_system_template(tpl['pddl']['system'])
...
reflection_agent = ReflectionAgent(
    ...
    retrieval_system_template=fill_retrieval_system_template(REF['rag']['retrieval']['system']),
    retrieval_human_template=REF['rag']['retrieval']['human'],
    rag_system_template=REF['rag']['lore']['system'],
    rag_human_template=REF['rag']['lore']['human'],
